frappe.provide("erpnext.machine_performance");

erpnext.machine_performance = {
	"filters": get_filters(),
	"formatter": function(value, row, column, data, default_formatter) {
		if (column.fieldname=="account") {
			...
			column.link_onclick =
				"erpnext.machine_performance.open_general_ledger(" + JSON.stringify(data) + ")";
			column.is_tree = true;
		}
	...
	onload: function(report) {
		...
		erpnext.machine_performance.filters = get_filters()
