...
var db = {123642: "Amoniak Tank", 123643: "Coolant Tank", 123648: "Chlor Tank", 123346: "Oil Tank", 130715: "Exhaust Chimney 1", 104973: "Exhaust Chimney 2", 131156: "Safety Area"};
...
Sandcastle.addToggleButton('selection', false, function(checked) {
    picking = checked;
    if (!picking) {
...
function selectFeature(feature) {
    ...
    selectedEntity.name = "FACTORY CHEMICAL";
    selectedEntity.description = 'Loading <div class="cesium-infoBox-loading"></div>';
    viewer.selectedEntity = selectedEntity;
    selectedEntity.description = '<table class="cesium-infoBox-defaultTable"><tbody>' +
                                    '<tr><th>CODE</th><td>' + element + '</td></tr>' +
                                    '<tr><th>Description</th><td>' + db[element]+ '</td></tr>' +
                                    '<tr><th>Maintenance Log</th><td>' + feature.pickId.key+ '</td></tr>' +
                                    '</tbody></table>';
